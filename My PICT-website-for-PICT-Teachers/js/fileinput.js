...
(function (factory) {
    ...
    var NAMESPACE, MODAL_ID, STYLE_SETTING, OBJECT_PARAMS, DEFAULT_PREVIEW, objUrl, compare, isIE, handler,
        ...
        cleanMemory, findFileName, checkFullScreen, toggleFullScreen, moveArray, -up;
    ...
    tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}" name="{uploadName}">' +
        '{uploadIcon}</button>';
    ...
    FileInput.prototype = {
       ...
       /* _uploadClick: function (e) {
        ...
        _renderFileActions: function (showUpload, showDelete, showZoom, showDrag, disabled, url, key, isInit) {
		    ...
		    .replace(/\{uploadName}/g, config.uploadName);
            }
            if (showZoom) {
        ...
        enable: function () {
            ...
            self.$container.find(
                ".btn-file, .fileinput-remove, .file-preview-frame button").removeAttr("disabled");
            self._initDragDrop();
            return self.$element;
        },
        upload: function () {
